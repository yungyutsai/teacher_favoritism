...
do "$do/1_clean_raw_data/1_3_clean_J1_W3_Teacher_a.do" //Students 9th grade test score
...
do "$do/3_analysis/FigB1B2_estimate.do"
do "$do/3_analysis/FigB1B2_graphing.do"
